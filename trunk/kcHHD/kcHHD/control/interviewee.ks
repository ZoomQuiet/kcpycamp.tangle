...
class Calendar:
	...
	def printPage(self,accountID):
		...
		Include("../../web/interviewee/intervieweeHeader.pih",title="查看面试日程")
...
class Result:
	...
	def printPage(self,accountID):
		...
		self.vPool={'CList':self.DataList}
		Include("../../web/interviewee/intervieweeHeader.pih",title="查看面试结果")
...
class Homepage:
	...
	def printPage(self,accountID):
		...
		Include("../../web/interviewee/intervieweeHeader.pih",title="主页")
...
def resume():
	...
	t = getUserResume(id)
	if t == True:
		Include("../../web/interviewee/intervieweeHeader.pih",title="填写简历")
...
def uploadresume():
	Include("../../web/interviewee/intervieweeHeader.pih",title="上传简历")
	Include("../../web/interviewee/Uploadfile.pih",id = sess.ID)
...
def modifyResume():
	...
	t = getUserResume(id)
	if t == False:
		Include("../../web/interviewee/intervieweeHeader.pih",title="修改简历")
		print "<div align = 'center'>"
		print "<h1>"
		print "您还没有填写简历"
		print"</h1></div>"
...
def showResume():
	...
	t = getUserResume(id)
	if t == False:
		Include("../../web/interviewee/intervieweeHeader.pih",title="显示简历")
		print "<div align = 'center'>"
		print "<h1>"
		print "您还没有填写简历"
		print"</h1></div>"
...
def resetPwd():
	Include("../../web/interviewee/intervieweeHeader.pih",title="修改密码")
	Include("../../web/interviewee/editPassword")
...
def check_resume(CardID,Name,Sex,School,Subject,Grade,Telephone,Native,Addr,AddrPhone,Email,QQ,ForeignLanguage,Character,Programming,MathAndPhysics,Scholarships,Project,SchoolDuty,MoreInfo,Advice):
	...
	t = ResumeInfo(number,id,name,sex)
	#t.ID = number
	#t.CardID = id
	#t.Name = name
	#t.Sex = sex
